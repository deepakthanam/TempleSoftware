...
def EnterExpense(AppRoot,MainFrame,ExpenseHead,ExpenseDescription,ExpenseAmount,ExpenseDate):
    ...
    try:
       ...
       Query1 = 'select max(EXPENSENUMBER) from pkt_temple.EXPENSEHISTORY;'         
       mycursor.execute(Query1)
       Maxvalue = [i[0] for i in mycursor.fetchall()]
       print Maxvalue
       ExpenseMaxValue = Maxvalue[0]+1

       SQL1 = 'insert into pkt_temple.EXPENSEHISTORY values ('+str(ExpenseMaxValue)+','+"'"+str(ExpenseHead)+"'"+','+"'"+str(ExpenseDescription)+"'"+","+str(ExpenseAmount)+","+"'"+str(ExpenseDate)+"')"+';'
    ...
    ExpenseMaxValue = ExpenseMaxValue+1
    ExpenseNumberValue = Label(MainFrame, font=('calibri',10,'bold'), text=str(ExpenseMaxValue), fg="Red", bd=12, anchor='w')
    ExpenseNumberValue.configure(width=30,bg="white")
    ExpenseNumberValue.grid(row=0,column=1)        
...
def DeleteExpense(ExpenseNumberValue):
    ...
    try:
        mycursor = mydb.cursor()
	SQL1 = "delete from pkt_temple.EXPENSEHISTORY where EXPENSENUMBER="+str(ExpenseNumberValue)+";"
        print SQL1
        ...
        MessageBox.showerror("Error", "Error in connecting to databse")

    mycursor.close()
    mydb.close()
    

def ResetView(AppRoot,MainFrame):
 
    ExpenseNumber = Label(MainFrame, font=('calibri',10,'bold'), text="Expense Number", bg="white", fg="white", bd=12, anchor='w')
    ExpenseNumber.configure(width=30,bg="white")
    ExpenseNumber.grid(row=9,column=0) 
    ExpenseHead = Label(MainFrame, font=('calibri',10,'bold'), text="Expense Head", bg="white", fg="white", bd=12, anchor='w')
    ExpenseHead.configure(width=30,bg="white")
    ExpenseHead.grid(row=9,column=1) 
    ExpenseDescription = Label(MainFrame, font=('calibri',10,'bold'), text="Expense Description", bg="white", fg="white", bd=12, anchor='w')
    ExpenseDescription.configure(width=30,bg="white")
    ExpenseDescription.grid(row=9,column=2) 
    ExpenseAmount = Label(MainFrame, font=('calibri',10,'bold'), text="Expense Amount", bg="white", fg="white", bd=12, anchor='w')
    ExpenseAmount.configure(width=30,bg="white")
    ExpenseAmount.grid(row=9,column=3) 
    ExpenseDate = Label(MainFrame, font=('calibri',10,'bold'), text="Expense Amount", bg="white", fg="white", bd=12, anchor='w')
    ExpenseDate.configure(width=30,bg="white")
    ExpenseDate.grid(row=9,column=4) 

    ExpenseNumberValue = Label(MainFrame, font=('calibri',10,'bold'), text="", bg="white", fg="white", bd=12, anchor='w')
    ExpenseNumberValue.configure(width=30,bg="white")
    ExpenseNumberValue.grid(row=10,column=0) 
    ExpenseHeadValue = Label(MainFrame, font=('calibri',10,'bold'), text="", bg="white", fg="white", bd=12, anchor='w')
    ExpenseHeadValue.configure(width=30,bg="white")
    ExpenseHeadValue.grid(row=10,column=1) 
    ExpenseDescriptionValue = Label(MainFrame, font=('calibri',10,'bold'), text="", bg="white", fg="white", bd=12, anchor='w')
    ExpenseDescriptionValue.configure(width=30,bg="white")
    ExpenseDescriptionValue.grid(row=10,column=2) 
    ExpenseAmountValue = Label(MainFrame, font=('calibri',10,'bold'), text="", bg="white", fg="white", bd=12, anchor='w')
    ExpenseAmountValue.configure(width=30,bg="white")
    ExpenseAmountValue.grid(row=10,column=3) 
    ExpenseDateValue = Label(MainFrame, font=('calibri',10,'bold'), text="", bg="white", fg="white", bd=12, anchor='w')
    ExpenseDateValue.configure(width=30,bg="white")
    ExpenseDateValue.grid(row=10,column=4) 


    DeleteExpenseButton = Label(MainFrame, font=('calibri',8,'bold'), text="", width=30, activebackground="white", padx=2, pady=2, bd=3, bg="white", fg="white", justify=CENTER)
	#BookButton.configure(width=15)
    DeleteExpenseButton.grid(row=11,column=3)


def ViewExpenseOption(AppRoot,MainFrame,ExpenseNumberValue):
    ...
    try:
        ...
        mycursor = mydb.cursor()
	SQL1 = "select * from pkt_temple.EXPENSEHISTORY where EXPENSENUMBER="+str(ExpenseNumberValue)+";"
        print SQL1
    ...
    ExpenseNumber = Label(MainFrame, font=('calibri',10,'bold'), text="Expense Number", fg="Red", bd=12, anchor='w')
    ExpenseNumber.configure(width=30,bg="white")
    ExpenseNumber.grid(row=9,column=0) 
    ExpenseHead = Label(MainFrame, font=('calibri',10,'bold'), text="Expense Head", fg="Red", bd=12, anchor='w')
    ExpenseHead.configure(width=30,bg="white")
    ExpenseHead.grid(row=9,column=1) 
    ExpenseDescription = Label(MainFrame, font=('calibri',10,'bold'), text="Expense Description", fg="Red", bd=12, anchor='w')
    ExpenseDescription.configure(width=30,bg="white")
    ExpenseDescription.grid(row=9,column=2) 
    ExpenseAmount = Label(MainFrame, font=('calibri',10,'bold'), text="Expense Amount", fg="Red", bd=12, anchor='w')
    ExpenseAmount.configure(width=30,bg="white")
    ExpenseAmount.grid(row=9,column=3) 
    ExpenseDate = Label(MainFrame, font=('calibri',10,'bold'), text="Expense Amount", fg="Red", bd=12, anchor='w')
    ExpenseDate.configure(width=30,bg="white")
    ExpenseDate.grid(row=9,column=4) 

    ExpenseValue = Label(MainFrame, font=('calibri',10,'bold'), text=str(n[0]), fg="Red", bd=12, anchor='w')
    ExpenseValue.configure(width=30,bg="white")
    ExpenseValue.grid(row=10,column=0) 
    ExpenseHeadValue = Label(MainFrame, font=('calibri',10,'bold'), text=str(n[1]), fg="Red", bd=12, anchor='w')
    ExpenseHeadValue.configure(width=30,bg="white")
    ExpenseHeadValue.grid(row=10,column=1) 
    ExpenseDescriptionValue = Label(MainFrame, font=('calibri',10,'bold'), text=str(n[2]), fg="Red", bd=12, anchor='w')
    ExpenseDescriptionValue.configure(width=30,bg="white")
    ExpenseDescriptionValue.grid(row=10,column=2) 
    ExpenseAmountValue = Label(MainFrame, font=('calibri',10,'bold'), text=str(n[3]), fg="Red", bd=12, anchor='w')
    ExpenseAmountValue.configure(width=30,bg="white")
    ExpenseAmountValue.grid(row=10,column=3) 
    ExpenseDateValue = Label(MainFrame, font=('calibri',10,'bold'), text=str(n[4]), fg="Red", bd=12, anchor='w')
    ExpenseDateValue.configure(width=30,bg="white")
    ExpenseDateValue.grid(row=10,column=4) 


    DeleteExpenseButton = Button(MainFrame, font=('calibri',8,'bold'), text="DELETE THIS EXPENSE", width=30, activebackground="white", padx=2, pady=2, bg='red', bd=3, fg='white', justify=CENTER, command = lambda : DeleteExpense(ExpenseNumberValue))
	#BookButton.configure(width=15)
    DeleteExpenseButton.grid(row=11,column=3)
   
    

def EnterExpenseOption(ExpenseDescription):
    ...
    try:
        ...
        mycursor = mydb.cursor()
	SQL1 = "select max(EXPENSEID) from pkt_temple.EXPENSEINFORMATION;"
	mycursor.execute(SQL1)

        Maxvalue = [i[0] for i in mycursor.fetchall()]
        ExpenseIDMaxValue = Maxvalue[0]+1


        SQL2 = 'insert into pkt_temple.EXPENSEINFORMATION values ('+str(ExpenseIDMaxValue)+','+"'"+str(ExpenseDescription)+"')"+';'
        print SQL2 
...
def ExpenseMethod():
	...
	TopFrame = Frame(AppRoot,height=50,width=1200,bg="white", bd=10, relief=FLAT)
	TopFrame.pack(side=TOP)

	MainFrame = Frame(AppRoot,height=650,width=1200,bg="white", bd=10, relief=FLAT)
	MainFrame.pack(side=TOP)

	OPTIONEXPENSEINFORMATION = GetExpenseInformation()

	variable1 = StringVar(AppRoot)
	variable1.set(OPTIONEXPENSEINFORMATION[0]) # default value

	TempleTitle = Label(TopFrame,font=('calibri',20,'bold'),text="Pookkattupadi Bhagavathi Temple Expense System                                                                                                                                 ", fg="Red", bd=20,bg="white", anchor='w')
	...
	TopFrame.config(bg='white')   
        ...
        try:
            ...
            mycursor = mydb.cursor()
	    SQL1 = "select max(EXPENSENUMBER) from pkt_temple.EXPENSEHISTORY;"
	    mycursor.execute(SQL1)
            Maxvalue =  mycursor.fetchone()
            newmaxvalue = Maxvalue[0] + 1        
        except mysql.connector.Error, e:
	...
	ExpenseNumber = Label(MainFrame, font=('calibri',10,'bold'), text="Expense Number", fg="Red", bd=12, anchor='w')
	ExpenseNumber.configure(width=30,bg="white")
	ExpenseNumber.grid(row=0,column=0) 
        ExpenseNumberValue = Label(MainFrame, font=('calibri',10,'bold'), text=str(newmaxvalue), fg="Red", bd=12, anchor='w')
	ExpenseNumberValue.configure(width=30,bg="white")
	ExpenseNumberValue.grid(row=0,column=1)        


	ExpenseText = Label(MainFrame, font=('calibri',10,'bold'), text="Expense Category", fg="Red", bd=12, anchor='w')
	ExpenseText.configure(width=30,bg="white")
	ExpenseText.grid(row=0,column=2)
 
	ExpenseMenu = ttk.Combobox(MainFrame, values=OPTIONEXPENSEINFORMATION)
#	ExpenseMenu.bind("<<ComboboxSelected>>", ComboFunction)
	ExpenseMenu.current(0)
	ExpenseMenu.config(font=('calibri',8,'bold'),width=30)
	ExpenseMenu.grid(row=0, column=3)

	ExpenseText = Label(MainFrame, font=('calibri',10,'bold'), text="Expense Description", fg="Red", bd=12, anchor='w')
	ExpenseText.configure(width=30,bg="white")
	ExpenseText.grid(row=1,column=0)
	ExpenseDescription = Entry(MainFrame, font=('calibri',8,'bold'), text="ExpenseDescription", bd=16,width=30)
	ExpenseDescription.grid(row=1,column=1)


	ExpenseAmount = Label(MainFrame, font=('calibri',10,'bold'), text="Expense Amount", fg="Red", bd=12, anchor='w')
	ExpenseAmount.configure(width=30,bg="white")
	ExpenseAmount.grid(row=1,column=2)
	ExpenseAmountValue = Entry(MainFrame, font=('calibri',8,'bold'), text="ExpenseAmount", bd=16, width=30,)
	ExpenseAmountValue.grid(row=1,column=3)

	ExpenseDate = Label(MainFrame, font=('calibri',10,'bold'), text="Expense Date", fg="Red", bd=12, anchor='w')
	ExpenseDate.configure(width=30,bg="white")
	ExpenseDate.grid(row=2,column=0)
	ExpenseDateValue = DateEntry(MainFrame, width=30, font=('calibri',8,'bold'), background='darkblue', foreground='white', borderwidth=2)
	ExpenseDateValue.grid(row=2,column=1)

	ExpenseBookButton = Button(MainFrame, font=('calibri',8,'bold'), text="ADD EXPENSE", width=30, activebackground="white", padx=2, pady=2, bg='red', bd=3, fg='white', justify=CENTER, command = lambda : EnterExpense(AppRoot,MainFrame, ExpenseMenu.get(),ExpenseDescription.get(), ExpenseAmountValue.get(), ExpenseDateValue.get_date()))
	#BookButton.configure(width=15)
	ExpenseBookButton.grid(row=3,column=2)


	LabelBlankSpace4 = Label(MainFrame, font=('calibri',8,'bold'), text="", bd=16, anchor='w')
	LabelBlankSpace4.configure(bg="white")
	LabelBlankSpace4.configure(width=25,bg="white",fg="white")
	LabelBlankSpace4.grid(row=4, column=0)

	LabelBlankSpace4 = Label(MainFrame, font=('calibri',8,'bold'), text="", bd=16, anchor='w')
	LabelBlankSpace4.configure(bg="white")
	LabelBlankSpace4.configure(width=25,bg="white",fg="white")
	LabelBlankSpace4.grid(row=5, column=0)


	ExpenseHeadText = Label(MainFrame, font=('calibri',10,'bold'), text="Expense Head Name", fg="Red", bd=12, anchor='w')
	ExpenseHeadText.configure(width=30,bg="white")
	ExpenseHeadText.grid(row=6,column=0)
	ExpenseOptionDescription = Entry(MainFrame, font=('calibri',8,'bold'), text="ExpenseOptionDescription", bd=16,width=30)
	ExpenseOptionDescription.grid(row=6,column=1)

	AddExpenseOptionButton = Button(MainFrame, font=('calibri',8,'bold'), text="ADD EXPENSE OPTION", width=30, activebackground="white", padx=2, pady=2, bg='red', bd=3, fg='white', justify=CENTER, command = lambda : EnterExpenseOption(ExpenseOptionDescription.get()))
	#BookButton.configure(width=15)
	AddExpenseOptionButton.grid(row=6,column=2)

	LabelBlankSpace4 = Label(MainFrame, font=('calibri',8,'bold'), text="", bd=16, anchor='w')
	LabelBlankSpace4.configure(bg="white")
	LabelBlankSpace4.configure(width=25,bg="white",fg="white")
	LabelBlankSpace4.grid(row=7, column=0)

      	ExpenseNumberView = Label(MainFrame, font=('calibri',10,'bold'), text="Expense Number", fg="Red", bd=12, anchor='w')
	ExpenseNumberView.configure(width=30,bg="white")
	ExpenseNumberView.grid(row=8,column=0)
	ExpenseNumberValueView = Entry(MainFrame, font=('calibri',8,'bold'), text="ExpenseNumberValue", bd=16,width=30)
	ExpenseNumberValueView.grid(row=8,column=1)   

	ViewExpenseOptionButton = Button(MainFrame, font=('calibri',8,'bold'), text="VIEW EXPENSE OPTION", width=30, activebackground="white", padx=2, pady=2, bg='red', bd=3, fg='white', justify=CENTER, command = lambda : ViewExpenseOption(AppRoot,MainFrame,ExpenseNumberValueView.get()))
	#BookButton.configure(width=15)
	ViewExpenseOptionButton.grid(row=8,column=2)

	ResetViewExpense = Button(MainFrame, font=('calibri',8,'bold'), text="RESET VIEW", width=30, activebackground="white", padx=2, pady=2, bg='red', bd=3, fg='white', justify=CENTER, command = lambda : ResetView(AppRoot,MainFrame))
	#BookButton.configure(width=15)
	ResetViewExpense.grid(row=8,column=3)
...
def ReportRetrieval(AppRoot,ReportButton,Date1,Date2):

    ReportButton.config(state='disabled')
    ReportButton.grid(row=0, column=4)

    file1 = open("/home/user/Desktop/reports/PoojaReport.txt","w")
    file1.write("REPORT from "+str(Date1)+" to "+str(Date2)+"\n\n")
    ...
    SQL1 = 'SELECT POOJANAME, SUM(POOJATOTALAMOUNT) FROM pkt_temple.BOOKINGHISTORY where  BOOKEDDATE between '+"'"+str(Date1)+"'"+' and '+"'"+str(Date2)+"'"+' group by POOJANAME;'

    print SQL1

    SQL2 = 'SELECT EXPENSEHEAD, SUM(EXPENSEAMOUNT) FROM pkt_temple.EXPENSEHISTORY where  EXPENSEDATE between'+"'"+str(Date1)+"'"+' and '+"'"+str(Date2)+"'"+' group by EXPENSEHEAD;'
    ...
    mycursor.execute(SQL1)
    b=[i[1] for i in mycursor.fetchall()]

    LabelValue = Label(AppRoot, font=('calibri',9,'bold'), text="Pooja details", bd=2, bg='red', anchor='w')
    LabelValue.configure(width=20)
    LabelValue.grid(row=3,column=0) 
    LabelValue = Label(AppRoot, font=('calibri',9,'bold'), text="Total Amount", bd=2, bg='red', anchor='w')
    LabelValue.configure(width=20)
    LabelValue.grid(row=3,column=1) 
    LabelValue = Label(AppRoot, font=('calibri',9,'bold'), text="Expense details", bd=2, bg='red', anchor='w')
    LabelValue.configure(width=20)
    LabelValue.grid(row=3,column=2) 
    LabelValue = Label(AppRoot, font=('calibri',9,'bold'), text="Total Amount", bd=2, bg='red', anchor='w')
    LabelValue.configure(width=20)
    LabelValue.grid(row=3,column=3) 
    LabelValue = Label(AppRoot, font=('calibri',9,'bold'), text="Summary details", bd=2, bg='red', anchor='w')
    LabelValue.configure(width=20)
    LabelValue.grid(row=3,column=4) 

    file1.write("Pooja details"+"\t"+"Total Amount"+"\n")
    ...
    for item in a: 
        rowcount = rowcount+1
        Reportline0 = str(item)+"\t"+str(b[n])+"\n"
        file1.write(Reportline0)      

        LabelValue = Label(AppRoot, font=('calibri',8,'bold'), text=str(item), bd=2, anchor='w')
        LabelValue.configure(width=30,bg="white")
        LabelValue.grid(row=rowcount,column=0)  
        
        LabelValue = Label(AppRoot, font=('calibri',8,'bold'), text=str(b[n]), bd=2, anchor='w')
        LabelValue.configure(width=15,bg="white")
        LabelValue.grid(row=rowcount,column=1)  

        TotalIncome = TotalIncome + float(b[n])
        n = n+1
        
    file1.write('***************************'+'\n')
   
    mycursor.execute(SQL2)
    c =[j[0] for j in mycursor.fetchall()]
    mycursor.execute(SQL2)
    d = [j[1] for j in mycursor.fetchall()]

    TotalExpense = 0
    rowcount = 5
    n = 0

    file1.write("Expense details"+"\t"+"Expense Amount"+"\n")

    for item in c:
        rowcount = rowcount+1 
        Reportline1 = str(item)+"\t"+str(d[n])+"\n"
        file1.write(Reportline1) 

        TotalExpense = TotalExpense + float(d[n])
        LabelValue = Label(AppRoot, font=('calibri',8,'bold'), text=str(item), bd=2, anchor='w')
        LabelValue.configure(width=30,bg="white")
        LabelValue.grid(row=rowcount,column=2)  
        
        LabelValue = Label(AppRoot, font=('calibri',8,'bold'), text=str(d[n]), bd=2, anchor='w')
        LabelValue.configure(width=15,bg="white")
        LabelValue.grid(row=rowcount,column=3)  
    ...
    file1.write("SUMMARY "+"\t"+"Details"+"\n")
    Reportline2 = 'Total Income:   '+str(TotalIncome)+'\n'
    file1.write(Reportline2)
    Reportline3 = 'Total Expense:  '+str(TotalExpense)+'\n'
    file1.write(Reportline3)
    Reportline4 = 'Balance     :   '+str(TotalIncome-TotalExpense)+'\n'
    file1.write(Reportline4)

    rowcount = 6

    LabelValue = Label(AppRoot, font=('calibri',8,'bold'), text=Reportline2, bd=2, anchor='w')
    LabelValue.configure(width=20,bg="white")
    LabelValue.grid(row=rowcount,column=4)
    rowcount = rowcount + 1  
        
    LabelValue = Label(AppRoot, font=('calibri',8,'bold'), text=Reportline3, bd=2, anchor='w')
    LabelValue.configure(width=20,bg="white")
    LabelValue.grid(row=rowcount,column=4)
    rowcount = rowcount + 1  

    LabelValue = Label(AppRoot, font=('calibri',8,'bold'), text=Reportline4, bd=2, anchor='w')
    LabelValue.configure(width=20,bg="white")
    LabelValue.grid(row=rowcount,column=4)
    rowcount = rowcount + 1  
    ...
    PrintReportButton = Button(AppRoot, font=('calibri',10,'bold'), text="  PRINT REPORT  ", activebackground="white", padx=2, pady=2, bg='red', bd=2, fg='white', justify=CENTER, width=20, command = lambda : PrintReport())
#BookButton.configure(width=15)
    PrintReportButton.grid(row=0, column=5)

    mycursor.close()
    mydb.close()


#    scrollbar = Scrollbar(AppRoot)
#     scrollbar.config(bg='red', padx=10, pady=10)
#     scrollbar.pack( side = RIGHT, fill=Y )
...
def ReportsMethod():
    ...
    AppRoot = Tk()
    AppRoot.geometry("1600x700+0+0")
    AppRoot.title("  REPORT   ")
...
#    win.config(width=150)
    ...
    AppRoot.config(width=1600)


    LabelDate1 = Label(AppRoot, font=('calibri',10,'bold'), text="From Date", bd=2, anchor='w')
    LabelDate1.configure(width=30,bg="white")
    LabelDate1.grid(row=0, column=0)
	#LabelDateValue = Label(BillingFrame, font=('calibri',8,'bold'), text=variabledate, bd=16, anchor='w')
	#LabelDateValue.configure(width=15,bg="white")
	#LabelDateValue.grid(row=9,column=1)

    LabelFromValue = DateEntry(AppRoot,  width=10, font=('calibri',10,'bold'), background='darkblue', foreground='white', borderwidth=2)
    LabelFromValue.grid(row=0, column=1)

    LabelDate2 = Label(AppRoot, font=('calibri',10,'bold'), text="To Date", bd=2, anchor='w')
    LabelDate2.configure(width=30,bg="white")
    LabelDate2.grid(row=0, column=2)
	#LabelDateValue = Label(BillingFrame, font=('calibri',8,'bold'), text=variabledate, bd=16, anchor='w')
	#LabelDateValue.configure(width=15,bg="white")
	#LabelDateValue.grid(row=9,column=1)

    LabelToValue = DateEntry(AppRoot, width=10, font=('calibri',10,'bold'), background='darkblue', foreground='white', borderwidth=2)
    LabelToValue.grid(row=0, column=3)

    ReportButton = Button(AppRoot, font=('calibri',10,'bold'), text="  GET REPORT  ", activebackground="white", padx=2, pady=2, bg='red', bd=2, fg='white', justify=CENTER, width=20, command = lambda : ReportRetrieval(AppRoot,ReportButton,LabelFromValue.get_date(),LabelToValue.get_date()))
#BookButton.configure(width=15)
    ReportButton.grid(row=0, column=4)
...
def BillingMethod():
	...
	#ChangeDateButton = Button(BilporlingFrame, font=('calibri',8,'bold'), text="Change date", activebackground="white", padx=2, pady=2, bg='red', bd=3, fg='white', justify=CENTER, command= lambda : ChangeOfferingDate(BillingFrame))
	#ChangeDateButton.configure(width=15)
	#ChangeDateButton.grid(row=9,column=2,sticky="ew")
...
from DatabaseFunctions1 import *
from PrintFunctions import *
from PrintFunctions3 import *
from PrintFunctions3 import PrintSampleReport
from GeneralFunctions import *
...
MainRoot = Tk()
MainRoot.geometry("750x750+0+0")
MainRoot.title("Pookkattupadi Bhagavathi Temple")


#..........................UI Frame definitions.....................................................................

now = datetime.datetime.now()
CurrentTime = 'Today is '+ str(now.strftime("%Y-%m-%d"))


TopMainFrame = Frame(MainRoot,width=650,bg="blue",relief=SUNKEN)
TopMainFrame.pack(side=TOP)

TempleTitle = Label(TopMainFrame,font=('calibri',20,'bold'),text="          Pookkattupadi Bhagavathi Temple        ", fg="Red", bd=20, bg="white", anchor='w')
TempleTitle.grid(row=0)
DateTimeValue = Label(TopMainFrame,font=('calibri',15,'bold'),text=str(CurrentTime), fg="Black", bd=20, bg="white", anchor='w')
DateTimeValue.grid(row=1)
TopMainFrame.config(bg='white')

LabelBlankSpace4 = Label(TopMainFrame, font=('calibri',8,'bold'), text="", bd=16, anchor='w')
LabelBlankSpace4.configure(bg="white",fg="white")
LabelBlankSpace4.grid(row=2)

PictureFrame = Frame(MainRoot,width=450,bg="white",bd=10, relief=SUNKEN)
PictureFrame.config(bg='white')
PictureFrame.pack(side=LEFT)

ContentFrame = Frame(MainRoot,width=300,bg="white",bd=10, relief=SUNKEN)
ContentFrame.config(bg='white')
ContentFrame.pack(side=LEFT)

path='/home/user/Downloads/Temple/PTemple/Images/pookkattupadi bhagavathi_v1.jpg'
img = ImageTk.PhotoImage(Image.open(path))
panel = Label(PictureFrame, image=img)
panel.pack(side="bottom", fill="both", expand="yes")

MainBottomFrame = Frame(MainRoot,width =650,bg="gold",relief=SUNKEN)
MainBottomFrame.pack(side=BOTTOM)


#...........Billing button ................................................................................................

LabelBlankSpace4 = Label(ContentFrame, font=('calibri',8,'bold'), text="", bd=16, anchor='w')
LabelBlankSpace4.configure(bg="white")
LabelBlankSpace4.configure(width=25,bg="white",fg="white")
LabelBlankSpace4.grid(row=0, column=0)

BillingButton = Button(ContentFrame, font=('calibri',10,'bold'), text="  BILLING  ", activebackground="white", padx=2, pady=2, bg='red', bd=3, fg='white', justify=CENTER, width=25, command = lambda : BillingMethod())
#BookButton.configure(width=15)
BillingButton.grid(row=1,column=0)

LabelBlankSpace4 = Label(ContentFrame, font=('calibri',8,'bold'), text="", bd=16, anchor='w')
LabelBlankSpace4.configure(bg="white")
LabelBlankSpace4.configure(width=25,bg="white",fg="white")
LabelBlankSpace4.grid(row=2, column=0)


#...........Reports button ................................................................................................
ReportButton = Button(ContentFrame, font=('calibri',10,'bold'), text="  REPORTS  ", activebackground="white", padx=2, pady=2, bg='red', bd=3, fg='white', justify=CENTER, width=25, command = lambda : ReportsMethod())
#BookButton.configure(width=15)
...
#...........EDIT button ................................................................................................
EditButton = Button(ContentFrame, font=('calibri',10,'bold'), text="  EDIT  ", activebackground="white", padx=2, pady=2, bg='red', bd=3, fg='white', justify=CENTER, width=25, command = lambda : EditMethod())
#BookButton.configure(width=15)
...
LabelBlankSpace4.configure(bg="white")
LabelBlankSpace4.configure(width=25,bg="white",fg="white")
LabelBlankSpace4.grid(row=6, column=0)


#...........EXPENSE button ................................................................................................
ExpenseButton = Button(ContentFrame, font=('calibri',10,'bold'), text="  EXPENSE  ", activebackground="white", padx=2, pady=2, bg='red', bd=3, fg='white', justify=CENTER, width=25, command = lambda : ExpenseMethod())
#BookButton.configure(width=15)
ExpenseButton.grid(row=7,column=0)
...
LabelBlankSpace4.configure(bg="white")
LabelBlankSpace4.configure(width=25,bg="white",fg="white")
LabelBlankSpace4.grid(row=10, column=0)

LabelBlankSpace4 = Label(ContentFrame, font=('calibri',8,'bold'), text="", bd=16, anchor='w')
LabelBlankSpace4.configure(bg="white")
LabelBlankSpace4.configure(width=25,bg="white",fg="white")
LabelBlankSpace4.grid(row=11, column=0)
